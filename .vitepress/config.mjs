...
import { inlineHighlightPlugin } from './markdown-it-inline-highlight.js';
...
export default defineConfig({
                ...
                line(line, lineNb) {
                    ...
                    for (let child of line.children) {
                        ...
                        if (child.properties.style === "--shiki-light:#6A737D;--shiki-dark:#6A737D") {
                            ...
                            let commentStart = child.children[0].value.match(/^(\s*(\/\/|#|\/\*)\s*)/);
                            if (!commentStart) {
    ...
    themeConfig: {
        ...
        footer: {
            message: `<a href="https://vitepress.dev">VitePress is goat</a> | <a href="https://github.com/Zezombye/blog/">Source</a> | © ${new Date().getFullYear()} Zezombye`,
        },
        socialLinks: [
